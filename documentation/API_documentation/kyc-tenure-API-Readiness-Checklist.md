...
Checklist for kyc-tenure v0.2.0 in r2.2
...
|  5 | API documentation                            |   M   |         M         |    M    |    M   |  Y   | Documentation embedded within [API definition](/code/API_definitions/kyc-tenure.yaml) |
